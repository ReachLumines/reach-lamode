    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Reusable garment blocks, design libraries, and pattern assets allow teams to build ranges more quickly. When buyers request design adjustments such as new trims, colorways, or silhouette changes, updates can be visualized and shared rapidly.
          </p>
