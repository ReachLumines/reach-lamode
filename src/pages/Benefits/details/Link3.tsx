    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Designers can create visually organized collection boards, line sheets, and story presentations that connect garments, fabrics, prints, and brand identity. This improves the way collections are presented to buyers and stakeholders.
          </p>
