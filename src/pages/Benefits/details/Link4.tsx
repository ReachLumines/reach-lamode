    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            When factories receive precise technical visuals with accurate proportions and construction details, the chances of incorrect samples are reduced. This saves time, materials, and labor during the sampling stage.
          </p>
